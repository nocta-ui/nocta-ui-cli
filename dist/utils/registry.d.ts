...
export declare function getRegistryAsset(assetPath: string): Promise<string>;
export declare function getComponentsByCategory(
	category?: string,
): Promise<Component[]>;
export declare function getCategories(): Promise<
	...
	>
>;
export declare function getComponentWithDependencies(
	name: string,
	visited?: Set<string>,
): Promise<Component[]>;
